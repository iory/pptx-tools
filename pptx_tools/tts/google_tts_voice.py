voice_name_to_language_code = {
    ...
    'ms-MY-Standard-A': 'ms-MY',  # Malay (Malaysia), FEMALE
    'ms-MY-Standard-B': 'ms-MY',  # Malay (Malaysia), MALE
    'ms-MY-Standard-C': 'ms-MY',  # Malay (Malaysia), FEMALE
    'ms-MY-Standard-D': 'ms-MY',  # Malay (Malaysia), MALE
    ...
    'pt-BR-Standard-B': 'pt-BR',  # Portuguese (Brazil), MALE
    'pt-BR-Wavenet-A': 'pt-BR',  # Portuguese (Brazil), FEMALE
    'pt-BR-Wavenet-B': 'pt-BR',  # Portuguese (Brazil), MALE
    ...
    'pa-IN-Standard-A': 'pa-IN',  # Punjabi (India), FEMALE
    'pa-IN-Standard-B': 'pa-IN',  # Punjabi (India), MALE
    'pa-IN-Standard-C': 'pa-IN',  # Punjabi (India), FEMALE
    'pa-IN-Standard-D': 'pa-IN',  # Punjabi (India), MALE
    'pa-IN-Wavenet-A': 'pa-IN',  # Punjabi (India), FEMALE
    'pa-IN-Wavenet-B': 'pa-IN',  # Punjabi (India), MALE
    'pa-IN-Wavenet-C': 'pa-IN',  # Punjabi (India), FEMALE
    'pa-IN-Wavenet-D': 'pa-IN',  # Punjabi (India), MALE
